        ...
        const timeoutId = window.setTimeout(async () => {
            try {
                ...
                const response = await fetch(
                    `/api/location-suggestions?q=${encodeURIComponent(normalizedAddress)}`,
                    {
                ...
                <div className="mb-4 flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                            Scrivi un indirizzo oppure tocca la mappa per selezionare il punto
                            esatto
                        </p>
                    </div>
                </div>
                ...
                <div className="space-y-3">
                    ...
                    {isResolvingAddress ? (
                        ...
                        <div className="rounded-2xl border border-dashed bg-muted/20 px-4 py-3 text-xs text-muted-foreground">
                            Nessun punto selezionato. Scrivi almeno 3 caratteri, scegli un
                            suggerimento, tocca la mappa oppure usa la tua posizione attuale.
                        </div>
                    )}
                </div>
            </CardContent>
